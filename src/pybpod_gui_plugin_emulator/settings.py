...
EMULATOR_PLUGIN_ICON = os.path.join(os.path.dirname(__file__), 'resources', 'develop_board.svg')
EMULATOR_LAUNCH_ICON = os.path.join(os.path.dirname(__file__), 'resources', 'launch.svg')
